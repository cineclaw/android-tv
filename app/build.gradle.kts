...
android {
    ...
    buildTypes {
        ...
        debug {
            // Same package as release for seamless dev deployment and preserved settings/auth
        }
    }
...
dependencies {
    ...
    // DataStore (Settings & Auth token)
    implementation(libs.androidx.datastore.preferences)

    // QR Code generation
    implementation(libs.zxing.core)

    // YouTube Player for in-app trailers
    implementation(libs.youtube.player)

    // Screenshot & Robolectric Testing
